...
class PoliclinicaReportController extends Controller
{
    ...
    public function exportCsv(Request $request, AuditService $audit): StreamedResponse
    {
        ...
        $export = $this->reportService->buildCsvExport($validated, WomenClinicAppointment::CLINIC_POLICLINICA);
    ...
    public function exportPdf(Request $request, AuditService $audit): Response
    {
        ...
        $export = $this->reportService->buildPdfExport($validated, WomenClinicAppointment::CLINIC_POLICLINICA);
