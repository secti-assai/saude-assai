<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="sa-card">
            ...
            <form method="GET" action="{{ route('women-clinic.reports') }}" class="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-3 items-end">
                <div>
                ...
                <div class="md:col-span-3 xl:col-span-6 flex flex-wrap justify-end gap-2">
                    <a href="{{ route('women-clinic.reports.export-csv', $exportFilters) }}" class="sa-btn-secondary">Exportar CSV</a>
                    <a href="{{ route('women-clinic.reports.export-pdf', $exportFilters) }}" class="sa-btn-secondary">Exportar PDF</a>
