            ...
            <div class="overflow-x-auto">
                <table class="sa-table">
                    ...
                    <tbody id="policlinica-recepcao-live-body">
                        ...
                        @empty
                            <tr><td colspan="5" class="text-center text-gray-500 py-6">Nenhum paciente para check-in.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
        ...
        (() => {
            ...
            const renderRows = (rows) => {
                if (!Array.isArray(rows) || rows.length === 0) {
                    tbody.innerHTML = '<tr><td colspan="5" class="text-center text-gray-500 py-6">Nenhum paciente para check-in.</td></tr>';
                    return;
                }
