                ...
                <div>
                    ...
                    <select name="specialty" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                        ...
                        <template x-if="clinic === '{{ \App\Models\WomenClinicAppointment::CLINIC_WOMEN }}'">
                            <>
                                <option value="{{ \App\Models\WomenClinicAppointment::SPECIALTY_CARDIOLOGIA }}" {{ old('specialty') == \App\Models\WomenClinicAppointment::SPECIALTY_CARDIOLOGIA ? 'selected' : '' }}>Cardiologia</option>
                                <option value="{{ \App\Models\WomenClinicAppointment::SPECIALTY_ORTOPEDIA }}" {{ old('specialty') == \App\Models\WomenClinicAppointment::SPECIALTY_ORTOPEDIA ? 'selected' : '' }}>Ortopedia</option>
                                <option value="{{ \App\Models\WomenClinicAppointment::SPECIALTY_PSIQUIATRIA }}" {{ old('specialty') == \App\Models\WomenClinicAppointment::SPECIALTY_PSIQUIATRIA ? 'selected' : '' }}>Psiquiatria</option>
                            </>
                        </template>
                        <!-- Policlinica -->
                        <template x-if="clinic === '{{ \App\Models\WomenClinicAppointment::CLINIC_POLICLINICA }}'">
                            <>
                                <option value="{{ \App\Models\WomenClinicAppointment::SPECIALTY_ODONTOLOGIA }}" {{ old('specialty') == \App\Models\WomenClinicAppointment::SPECIALTY_ODONTOLOGIA ? 'selected' : '' }}>Odontologia</option>
                                <option value="{{ \App\Models\WomenClinicAppointment::SPECIALTY_FISIOTERAPIA }}" {{ old('specialty') == \App\Models\WomenClinicAppointment::SPECIALTY_FISIOTERAPIA ? 'selected' : '' }}>Fisioterapia</option>
                            </>
                        </template>
                    </select>
